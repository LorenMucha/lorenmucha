  ...
  <div id="work" class="section">
    ...
    <div class="grid grid-flow-row gap-3 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-3">
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="p-5">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Persequeris graece commune molestie fastidii.
              ...
              mus. Ea epicurei sociis quot omittam malorum ultrices suavitate duo. Adipisci fringilla equidem magna orci
              menandri himenaeos sapien eius ridiculus.</p>
            <a href="#"
      ...
      <div class="flex flex-wrap items-center justify-center">
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img class="rounded-t-lg" src="~assets/images/ioer_app.png" loading="lazy" alt=""/>
          </a>
          <div class="p-5">
            <a href="#">
              <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">IÖR Monitor App</h5>
            </a>
