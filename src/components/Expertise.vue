  ...
  data() {
    return {
      frontend: [
        ...
        { component: Bootstrap, title: 'Bootstrap' },
        { component: Vuejs, title: 'Vuejs' },
        { component: TailwindCss, title: 'TailwindCss' },
        { component: Nuxt, title: 'Nuxt' },
        { component: Node, title: 'Node' },
        { component: Angular, title: 'Angular' },
      ],
      backend: [
        { component: Java, title: 'Java' },
        { component: Python, title: 'Python' },
        { component: Springboot, title: 'Spring Boot' },
        { component: Flask, title: 'Flask' },
        { component: Ruby, title: 'Ruby' },
        { component: Kotlin, title: 'Kotlin' },
      ],
    }
  },
}
