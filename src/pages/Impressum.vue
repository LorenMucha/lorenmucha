<template>
  <section class="container sm:mt-20 mt-16 px-10">
    ...
    <p class="mt-2">
      ...
      Telefon: 01575-0286721<br>
      E-Mail: <a href="mailto:info@lorenmucha.de">info@lorenmucha.de</a><br>
    </p>
    <p class="mt-2">
      <strong>Umsatzsteuer-Nummer: </strong> <br>
      35/290/7880<br><br>
    </p>
    ...
    <p>
      Impressum vom
      <a href="https://www.impressum-generator.de" class="text-blue-600">Impressum Generator</a> der
      <a href="https://www.kanzlei-hasselbach.de/" class="text-blue-600">Kanzlei Hasselbach, Rechtsanwälte für Arbeitsrecht und Familienrecht</a>
    </p>
  </section>
</template>
