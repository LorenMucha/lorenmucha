import locale_de from "../src/locales/de-DE.json" assert { type: "json" };
export const localeCodes = ["gb","de"]

export const localeMessages = {
  "de": () => Promise.resolve(locale_de),
  "gb": () => import("../src/locales/en-GB.json" /* webpackChunkName: "lang-gb" */),
}

export const additionalMessages = Object({"gb":[],"de":[],})

export const resolveNuxtI18nOptions = async (context) => {
  const nuxtI18nOptions = Object({})
  const vueI18nOptionsLoader = async (context) => Object({"legacy":false,"locale":"de","fallbackLocale":"de","availableLocales":["gb","de"],})
...
export const nuxtI18nInternalOptions = Object({__normalizedLocales: [Object({"code":"gb","file":"en-GB.json"}),Object({"code":"de","file":"de-DE.json"})]})
