...
<template>
  ...
  >
    <div>
      <!-- content -->
      <div
        class="border w-[900px] rounded-lg shadow-lg relative flex flex-col bg-white outline-none focus:outline-none !overflow-auto"
      >
        <div class="flex justify-center p-5 flex-col">
          <div class="flex flex-row min-h-screen justify-center items-center"></div>
          <div>
