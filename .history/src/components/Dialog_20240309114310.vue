    ...
    <div>
      ...
      >
        ...
        <div class="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
          <button
            type="button" class="g-transparent hover:bg-green-100 text-green-900 font-semibold hover:text-black py-2 px-4 border border-green-900 hover:border-transparent rounded"
            @click="toggleDialog()"
          >
            Schließen
          </button>
