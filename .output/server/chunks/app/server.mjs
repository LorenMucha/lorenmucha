import { hasInjectionContext, getCurrentInstance, toRef, isRef, inject, version, defineAsyncComponent, h, onUnmounted, useSSRContext, ref, watchEffect, watch, computed, Fragment, defineComponent, withCtx, createVNode, createApp, reactive, effectScope, isReactive, toRaw, unref, getCurrentScope, onScopeDispose, nextTick, Suspense, Transition, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, toRefs, markRaw, Text, mergeProps, isShallow } from 'vue';
...
const _routes = [
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "ClimbingDiary___gb",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/gb/ClimbingDiary",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/ClimbingDiary-ced45018.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "ClimbingDiary___de",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/ClimbingDiary",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/ClimbingDiary-ced45018.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ed119119.mjs').then((m) => m.default || m)
  },
  {
    name: "index___de",
    path: "/",
...
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-0c29a202.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-86969d7d.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-94831a8d.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-b45f8199.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-37cea334.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-1bb27fc3.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./_nuxt/ContentSlot-c9f2e4b0.mjs').then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import('./_nuxt/Markdown-dc983386.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-b21cbc96.mjs').then((r) => r.default));
...
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-660cfe85.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-7d20f167.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-dc5c4e00.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-cccbe6bc.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-664a41f2.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-3ca3e249.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-5da06891.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-9d5f1e5e.mjs').then((r) => r.default));
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-9f059384.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-98fee6e8.mjs').then((r) => r.default));
...
const locale_de = {
  "header": {
    "cv": (ctx) => {
      ...
      return _normalize(["Lebenslauf"]);
    },
    "contact": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Kontakt"]);
    },
    "greet": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Hallo! Ich bin Loren Mucha"]);
    },
    "role": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Fullstack Software Entwickler"]);
    },
    "about": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Ich bin Full Stack Software-Entwickler, mit einer Passion für kreative Lösungen. Von der Benutzeroberfläche bis zur Backend-Architektur - ich gestalte digitale Welten. Entdecken Sie hier meine Projekte und die Prozesse hinter dem Code."]);
    }
  },
  "cv": (ctx) => {
    const { normalize: _normalize } = ctx;
  ...
  "work": {
    "header": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Projekte"]);
    },
    "ioer_monitor": {
      "header": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["IÖR Moitor"]);
      },
      "intro": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["Der IÖR-Monitor ist ein Web GIS um intuitiv Fragen zur Flächennutzung in Deutschland zu beantworten."]);
      }
    },
    "climbing_diary": {
      "header": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["Climbing Diary"]);
      },
      "intro": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["Virtuelles Tagebuch mit Statistischer Auswertung der persönlichen Leistungen, als native Android App."]);
      }
    },
    "max_jacob_theater": {
      "header": (ctx) => {
      ...
      "intro": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["Theaterwebsite des Traditionsverein Hohnsteiner Kasper e.V. als CMS System mit Kartenverkauf und Programminfo."]);
      }
    },
    "monitor_api": {
      "header": (ctx) => {
      ...
      "intro": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["REST API zur Geodatenprocessierung innerhalb für das <a class='active-link' href='https://http://sora.git.gesis.org' target='_blank'>Sora-Forschungsprojektes</a> mit Usermanagement."]);
      }
    },
    "land_use_monitor": {
      "header": (ctx) => {
      ...
      "intro": (ctx) => {
        const { normalize: _normalize } = ctx;
        return _normalize(["Stellt Informationen zur Flächenstruktur und deren Entwicklung sowie zur Qualität flächendeckend für die BRD als <b>App</b> bereit."]);
      }
    }
  },
  "tools": {
    "languages": (ctx) => {
      const { normalize: _normalize } = ctx;
      return _normalize(["Programmiersprachen"]);
    }
  }
};
const localeCodes = ["gb", "de"];
const localeMessages = {
  "de": () => Promise.resolve(locale_de),
  "gb": () => import(
    './_nuxt/en-GB-3e481955.mjs'
    /* webpackChunkName: "lang-gb" */
  )
};
const additionalMessages = Object({ "gb": [], "de": [] });
const resolveNuxtI18nOptions = async (context) => {
  const nuxtI18nOptions = Object({});
  const vueI18nOptionsLoader = async (context2) => Object({ "legacy": false, "locale": "de", "fallbackLocale": "de", "availableLocales": ["gb", "de"] });
  nuxtI18nOptions.vueI18n = await vueI18nOptionsLoader();
  nuxtI18nOptions.locales = [Object({ "code": "gb", "file": "en-GB.json" }), Object({ "code": "de", "file": "de-DE.json" })];
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "gb", "file": "en-GB.json" }), Object({ "code": "de", "file": "de-DE.json" })] });
...
function detectLocale(route, context, routeLocaleGetter, nuxtI18nOptions, initialLocaleLoader, normalizedLocales, localeCodes2 = []) {
  ...
  const { locale: browserLocale, stat, reason, from } = nuxtI18nOptions.detectBrowserLanguage ? detectBrowserLanguage(route, context, nuxtI18nOptions, nuxtI18nInternalOptions, localeCodes2, initialLocale) : { locale: "", stat: false, reason: "unknown", from: "unknown" };
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-3defea60.mjs').then((m) => m.default || m))
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="antialiased bg-white"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
            _push2(`</section>`);
          } else {
            return [
              createVNode("section", { class: "antialiased bg-white" }, [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-e5a7a776.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-a0ecefa8.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-6f5e64d4.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useRoute as a, useRuntimeConfig as b, createError as c, useRouter as d, entry$1 as default, useState as e, useNuxtApp as f, useRequestEvent as g, defineStore as h, navigateTo as n, useHead as u };
