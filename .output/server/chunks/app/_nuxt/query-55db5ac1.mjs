...
import { f as useNuxtApp, c as createError, b as useRuntimeConfig } from '../server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'ufo';
import { hash } from 'ohash';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-1740b479.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-f892e7c1.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-55db5ac1.mjs.map
