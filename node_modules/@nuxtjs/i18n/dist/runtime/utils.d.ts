...
export declare function navigate<Context extends NuxtApp = NuxtApp>(i18n: I18n, redirectPath: string, locale: string, route: Route | RouteLocationNormalized | RouteLocationNormalizedLoaded, { status, rootRedirect, differentDomains, skipSettingLocaleOnNavigate }?: {
    status?: number;
