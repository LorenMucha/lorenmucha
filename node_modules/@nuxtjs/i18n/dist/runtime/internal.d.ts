...
export type DetectBrowserLanguageNotDetectReason = 'unknown' | 'not_found_match' | 'not_redirect_on_root' | 'not_redirect_on_no_prefix';
...
export declare function detectBrowserLanguage<Context extends NuxtApp = NuxtApp>(route: string | Route | RouteLocationNormalized | RouteLocationNormalizedLoaded, context: any, nuxtI18nOptions: DeepRequired<NuxtI18nOptions<Context>>, nuxtI18nInternalOptions: DeepRequired<NuxtI18nInternalOptions>, localeCodes?: string[], locale?: Locale): DetectBrowserLanguageFromResult;
